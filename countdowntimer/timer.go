...
func main() {
	deadline := flag.String("deadline_cli_parameter", "", "The deadline for the countdown timer in RFC3339 format (e.g. 2019-12-25T15:00:00+01:00)")
	flag.Parse()

	// the deadline_cli_parameter is necessary
	if *deadline == "" {
		flag.PrintDefaults()
		os.Exit(1)
	}
